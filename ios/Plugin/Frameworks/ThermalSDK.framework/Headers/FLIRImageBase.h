 ...
 *  Important: When rotating only the colorized pixels (UIImage), adding new measurements will require you to handle the difference in the displayed image and the actual FLIRThermalImage i.e. calculate the correct positions and redraw measurement and this can became really complicated.
 */
